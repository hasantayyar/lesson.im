  ...
  <body>
              <div class="navbar navbar-inverse">
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="#">Lessom.im</a>
                </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="page-header">
              <h1 id="type">What is Lesson.im</h1>
            </div>
          </div>
        </div>
...
<a href="https://github.com/hasantayyar/lesson.im">source on github</a> |
</small>
</p>
